# Day 19: JSON and Device State

## Goal

Represent device state as structured data that can be sent over the network.
...
**Project:** Print LED state, ADC value, and uptime as JSON.
