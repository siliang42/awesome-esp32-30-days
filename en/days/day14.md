# Day 14: Buzzers, Relays, and Actuators

## Goal

Learn that outputs include sound, relay control, and motion, not just LEDs.
...
**Project:** Trigger a buzzer with a button and mirror the status with an LED.
