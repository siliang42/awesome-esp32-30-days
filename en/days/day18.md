# Day 18: Web Server: Control an LED from Your Phone

## Goal

Run a web server on ESP32 and control GPIO from a browser.
...
**Project:** Open the ESP32 IP on your phone and toggle an LED.
