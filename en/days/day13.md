# Day 13: SPI and High-Speed Peripherals

## Goal

Understand MOSI, MISO, SCLK, CS, and when SPI is better than I2C.
...
**Project:** Draw an I2C vs SPI wiring comparison and list real use cases.
