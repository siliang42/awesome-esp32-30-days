# Day 06: Serial Monitor: Let the ESP32 Speak

## Goal

Use Serial output as your primary debugging window.
...
**Project:** Log every button and LED state change to the serial monitor.
