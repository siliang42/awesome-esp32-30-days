# Day 25: Timers, millis, and Non-Blocking Programs

## Goal

Replace heavy delay calls with millis-based task scheduling.
...
**Project:** Blink LED, read button, and refresh display without blocking each other.
