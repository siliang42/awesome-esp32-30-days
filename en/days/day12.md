# Day 12: OLED Display: Text, Values, and Status

## Goal

Drive an SSD1306 OLED and display useful device state.
...
**Project:** Build a tiny dashboard showing uptime, button state, and ADC value.
