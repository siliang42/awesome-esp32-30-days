# Day 17: HTTP Client: Request Network Data

## Goal

Use HTTP GET and understand URLs, status codes, response bodies, and timeouts.
...
**Project:** Request a public or local API and print the response.
