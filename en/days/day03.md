# Day 03: Breadboards, Resistors, LEDs, and Safe Wiring

## Goal

Understand closed circuits, LED polarity, current-limiting resistors, and safe wiring habits.
...
**Project:** Move from the onboard LED to an external LED on a breadboard.
