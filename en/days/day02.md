# Day 02: Development Environment and Your First Blink

## Goal

Install Arduino IDE or PlatformIO, configure the board and port, upload firmware, and blink an LED.
...
**Project:** Upload a Blink sketch and make the onboard or external LED flash once per second.
