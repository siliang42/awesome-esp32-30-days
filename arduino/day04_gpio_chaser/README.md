# Day 04: GPIO 数字输出：流水灯与状态机思维

## 今日目标

使用多个 GPIO 控制多个 LED，理解非阻塞思维的第一步。

## 可烧录代码

- Arduino 工程文件：`day04_gpio_chaser.ino`
- 打开方式：用 Arduino IDE 打开本目录下的 `day04_gpio_chaser.ino`，选择 ESP32 开发板和串口后上传。
