# Day 02: 搭建 Arduino IDE / PlatformIO 与第一个 Blink

## 今日目标

完成开发环境、板卡包、串口驱动、上传流程，并点亮板载 LED 或外接 LED。

## 可烧录代码

- Arduino 工程文件：`day02_blink.ino`
- 打开方式：用 Arduino IDE 打开本目录下的 `day02_blink.ino`，选择 ESP32 开发板和串口后上传。
