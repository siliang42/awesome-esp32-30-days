# Day 06: 串口监视器：让 ESP32 学会说话

## 今日目标

掌握 Serial 输出、调试日志、变量观察和基础故障定位。

## 可烧录代码

- Arduino 工程文件：`day06_serial_debug.ino`
- 打开方式：用 Arduino IDE 打开本目录下的 `day06_serial_debug.ino`，选择 ESP32 开发板和串口后上传。
