...
理解深度睡眠、唤醒源、电池供电、功耗预算和应用场景。

## 可烧录代码

- Arduino 工程文件：`day26_deep_sleep.ino`
- 打开方式：用 Arduino IDE 打开本目录下的 `day26_deep_sleep.ino`，选择 ESP32 开发板和串口后上传。
