# Day 19: JSON 与数据结构：从字符串到设备状态

## 今日目标

理解 JSON 表示设备状态，学习解析和生成简单 JSON。

## 可烧录代码

- Arduino 工程文件：`day19_json_status.ino`
- 打开方式：用 Arduino IDE 打开本目录下的 `day19_json_status.ino`，选择 ESP32 开发板和串口后上传。
...
把 LED 状态、ADC 数值、运行时间组织成 JSON 输出。
