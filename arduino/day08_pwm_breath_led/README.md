# Day 08: PWM：让 LED 呼吸起来

## 今日目标

理解 PWM 的占空比、频率、通道，用 ESP32 输出渐变亮度。

## 可烧录代码

- Arduino 工程文件：`day08_pwm_breath_led.ino`
- 打开方式：用 Arduino IDE 打开本目录下的 `day08_pwm_breath_led.ino`，选择 ESP32 开发板和串口后上传。
